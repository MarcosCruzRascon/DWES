...
class GBD
{
     ...
     *      Ejemplo $array = ['idespecie'=>3,'nombre'=>'caballo','chip'=>false];
     * @return void
     */
     ...
     * @param array $valoresid valores de la/s clave/s primaria/s
     * Ejemplo:
     *      $array = ['nombre'=>'caballito'];
     *      $array2 = ['3'];
     *      $tabla = $conexion->update('especie', $array, $array2);
     * @return void
     */
     ...
     * Ejemplo
     *      $array = ['3'];
     *      $tabla = $conexion->delete('especie', $array);
     * @return void
     */
